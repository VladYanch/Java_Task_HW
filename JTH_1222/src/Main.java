...
//        В противном случае вернуть -1
        ...
        System.out.println(repElFinder(arr)); // вернет 3

        int[] arr1 = new int[] {4, 2, 4, 1, 4, 4, 3, 5, 4, 4};
        System.out.println(repElFinder(arr1)); // вернет 4

        int[] arr2 = new int[]{4, 3, 4, 3, 3, 4, 3, 3, 4, 4};
        System.out.println(repElFinder(arr2)); // вернет -1
    }

    public static int repElFinder(int[] arr) {
